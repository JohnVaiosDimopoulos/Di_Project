...
Argument_Data_Ptr Create_Argument_Data(const char* , const char*, const int , const int);
const char* Get_FileName_1(Argument_Data_Ptr);
const char* Get_FileName_2(Argument_Data_Ptr);
const int Get_Join_Column_1(Argument_Data_Ptr);
const int Get_Join_Column_2(Argument_Data_Ptr);
