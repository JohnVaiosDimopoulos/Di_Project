...
Argument_Data_Ptr Create_Argument_Data(
    const char* File_Name_1 , const char* File_Name_2, const int Join_Column_1, const int Join_Column_2){
  ...
  Data->Join_Column_1 = Join_Column_1;
  Data->Join_Column_2 = Join_Column_2;
  return Data;
}
...
const int Get_Join_Column_1(Argument_Data_Ptr Data){
  return Data->Join_Column_1;
}

const int Get_Join_Column_2(Argument_Data_Ptr Data){
  return Data->Join_Column_2;
}
